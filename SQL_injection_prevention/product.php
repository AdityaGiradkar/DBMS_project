    ...
    <div class="container">
        <div class="main container-fluid">
            <form class="form-inline my-2 my-lg-0" method="GET" action="">
                    <input class="form-control mr-sm-2 input-bar" style = "width: 90%;" type="search" placeholder="Search" name="product-name"  aria-label="Search" minlength="1">
        ...
        <div class="table-responsive-md">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    ?>        
                            <tr>
                                <th scope="row">No data found belong to search string.</th>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
